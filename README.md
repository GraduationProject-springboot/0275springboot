...
# 0275springboot个人云盘管理系统的设计与实现

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1jqaLe1EbH?p=41)


# 第1章 绪论
## 1.1选题动因
当前的网络技术，软件技术等都具备成熟的理论基础，市场上也出现各种技术开发的软件，这些软件都被用于各个领域，包括生活和工作的领域。随着电脑和笔记本的广泛运用，以及各种计算机硬件的完善和升级，市面上的电脑和笔记本的性能都得到提升，可以支持的软件也逐渐增多，因此，在计算机上安装软件来发挥其高效地信息处理的作用，则很受人们的青睐。对于个人云盘管理系统信息来讲，通过手工形式处理，在面对庞大的信息数量时，就显得不适宜了，首先需要花费的时间比较多，其次数据出错率比较高，而且对错误的数据进行更改也比较困难，最后，检索数据费事费力。因此，为了解决上述问题，有必要建立个人云盘管理系统，来规范个人云盘管理系统信息管理流程，让管理工作可以系统化和程序化，同时，个人云盘管理系统的有效运用可以帮助管理人员准确快速地处理信息。
## 1.2目的和意义
个人云盘管理系统可以对个人云盘管理系统信息进行集中管理，可以真正避免传统管理的缺陷。个人云盘管理系统是一款运用软件开发技术设计实现的应用系统，在信息处理上可以达到快速的目的，不管是针对数据添加，数据维护和统计，以及数据查询等处理要求，个人云盘管理系统都可以轻松应对。所以，个人云盘管理系统的运用是让个人云盘管理系统信息管理升级的最好方式。它可以实现信息处理的便利化要求，还可以规范信息处理的流程，让事务处理成为管理人员手中的一件简单事，而不是之前手工处理时的困难事。尽管个人云盘管理系统具备较完善的功能，但是也需要管理人员利用闲暇时间提升自身素质以及个人能力，在操作个人云盘管理系统时可以最大化运用个人云盘管理系统提供的功能，让系统在满足高效率处理数据的同时，也能始终稳定运行，还可以确保数据的可靠性与数据处理的质量。
## 1.3论文结构安排
...
# 第2章 开发环境与技术
开发个人云盘管理系统需要搭建编程的环境，也需要通过调查，对各个相关技术进行分析，选取适合本系统开发的技术与工具。
## 2.1 MYSQL数据库
...
### 3.1.1操作可行性分析
开发本系统需要用到的工具，本人都比较熟悉，因此可以使用这些工具，完整开发个人云盘管理系统。此外，个人云盘管理系统在功能上，基本都是完成信息的处理，涵盖了添加，修改，删除等，而且操作者面对的都是各个功能操作界面，并不是编码后台，所以一般的使用者都可以通过操作界面轻松完成信息的加工处理。因此，本系统操作可行。
### 3.1.2经济可行性分析
...
### 3.1.3技术可行性分析
本系统需要的软件包括Eclipse，Tomcat，Mysql等，这些工具都接触并使用过，至于JAVA，B/S，vue，Html等技术，图书馆都有对应的书籍可以参考学习，加上平时课堂上学习的编程小项目对这些技术都有讲解，另外，本人也从课程设计作业中锻炼了编程能力。所以在技术上，可以完成个人云盘管理系统的编程开发。

通过上面的分析，已经确定了本系统在经济上的可行，本系统在技术上的可行，本系统在操作上的可行。由此，可以得出在目前的条件下，对于个人云盘管理系统的设计与实现是可以进行下去的。
## 3.2系统流程分析
...
图3.3 查询信息流程图
## 3.3系统性能分析
分析个人云盘管理系统对于性能的需求主要还是从下面的5个角度来分析，它们分别是系统的实用性，系统的适应性，系统的易操作性，系统的安全性和系统的易维护性。
...
![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\论坛.jpg](/md/blog.005.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\论坛.jpg")
图4.1 论坛实体属性图

（2）下图是用户实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\用户.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\用户.jpg")
图4.2 用户实体属性图

（3）下图是博客信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\博客信息.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\博客信息.jpg")
图4.3 博客信息实体属性图

（4）下图是博客信息收藏实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\博客信息收藏.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\博客信息收藏.jpg")
图4.4 博客信息收藏实体属性图

（5）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\公告信息.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\公告信息.jpg")
图4.5 公告信息实体属性图

（6）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\字典表.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\字典表.jpg")
图4.6 字典表实体属性图

（7）下图是书籍信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\书籍信息.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\书籍信息.jpg")
图4.7 书籍信息实体属性图

（8）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\用户表.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\用户表.jpg")
图4.8 用户表实体属性图

（9）下图是视频信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\gerenyunpanguanli\视频信息.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\gerenyunpanguanli\视频信息.jpg")
图4.9 视频信息实体属性图
...
|10|boke\_content|String|博客内容|是|
...
|3|yonghu\_id|Integer|用户|是|
|4|zhiyuanzhe\_id|Integer|zhiyuanzhe|是|
...
|3|shipin\_types|Integer|视频类别|是|
|4|shipin\_photo|String|视频图片|是|
|5|shipin\_video|String|视频|是|
|6|yonghu\_id|Integer|用户|是|
|7|shipin\_clicknum|Integer|点击次数|是|
|8|insert\_time|Date|发布日期|是|
|9|shipin\_content|String|视频详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shuji\_name|String|书籍标题|是|
|3|shuji\_types|Integer|书籍类别|是|
|4|shuji\_photo|String|书籍图片|是|
|5|shuji\_file|String|书籍下载|是|
|6|yonghu\_id|Integer|用户|是|
|7|shuji\_clicknum|Integer|点击次数|是|
|8|insert\_time|Date|发布日期|是|
|9|shuji\_content|String|书籍详情|是|
|10|create\_time|Date|创建时间|是|
表4.8用户表
